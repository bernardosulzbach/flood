...
public abstract class InitializationAlgorithms {
    ...
    private static final InitializationAlgorithm SIMPLE = new InitializationAlgorithm() {
        @Override
    ...
    private static final InitializationAlgorithm SQUARES = new InitializationAlgorithm() {
        @Override
        public void initialize(TileMatrix tileMatrix) {
            Dimension matrixDimensions = tileMatrix.getDimensions();
            for (int y = 0; y < matrixDimensions.height; y++) {
    ...
    private static final InitializationAlgorithm COMPLEX = new InitializationAlgorithm() {
        @Override
        public void initialize(TileMatrix tileMatrix) {
            double randomDouble;
            Dimension matrixDimensions = tileMatrix.getDimensions();
